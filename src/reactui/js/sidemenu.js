...
(function (UIComponents) {
    UIComponents.SideMenu = React.createClass({
        ...
        render: function () {
            ...
            }), React.DOM.div({ id: "side-menu-other-buttons", className: "grid-column" }, UIComponents.SideMenuSave(), UIComponents.SideMenuZoom()), React.DOM.div({ id: "side-menu-stats" }, React.DOM.div({ id: "player-level-wrapper" }, React.DOM.progress({
                id: "player-level",
                ref: "exp",
                value: 0,
                max: 100
