module CityGame
{
  export module EmployeeModifiers
  {

    export var fastFoodTrait1: IPlayerModifier =
    {
      type: "fastFoodTrait1",
    ...
    export var clicksPerShoppingTrait1: IPlayerModifier =
    {
    ...
    export var apartmentTrait1: IPlayerModifier =
    {
    ...
    export var apartmentFactoriesTrait1: IPlayerModifier =
    {
    ...
    export var factoryBuildingsTrait1: IPlayerModifier =
    {
    ...
    export var hotelShoppingTrait1: IPlayerModifier =
    {
    ...
    export var hotelTrait1: IPlayerModifier =
    {
      type: "hotelTrait1",
      title: "Concierge",
